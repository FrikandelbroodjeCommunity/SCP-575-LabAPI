...
public class Config
{
    ...
    public string[] AudioFiles { get; set; } = { "Chase.ogg" };
...
public class BlackoutConfig
{
    ...
    public CassieMessage Cassie { get; set; } = new(
...
public class Scp575Config
{
    ...
    /// </summary>
    [Description("The reason that will be shown to the player when killed by SCP-575.")]
    public string KillReason { get; set; } = "You were eaten by SCP-575, aim with a lit flashlight next time";
    ...
    public float DelayChase { get; set; } = 3.5f;
    ...
    public float MovementSpeedFast { get; set; } = 5.2f;
    ...
    public float MovementSpeed { get; set; } = 4.2f;
